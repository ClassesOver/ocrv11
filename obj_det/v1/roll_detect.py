...
converter = {'invoice_code': 'invoice_code', 'invoice_number': 'invoice_number', 'totalAmount': 'total_amount',
             'billingDate': 'billing_date', 'checkcode': 'check_code',
...
# Load model
if config.GPU:
    model = attempt_load(pub_weights, map_location=lambda storage, loc: storage.cuda(config.GPUID))  
else:
